    ...
    <>
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`} id="navbar" role="navigation" aria-label="Main Navigation">
        <div className="container">
          ...
          <div className="nav-actions">
            <Link to="/register" className="btn btn-outline-blue btn-sm nav-btn-join" onClick={closeMenu}>
              Join Us
            </Link>
            <Link to="/donate" className="btn btn-green btn-sm nav-cta" id="navDonateBtn" onClick={closeMenu}>
              Donate Now
            </Link>
      ...
      <div className={`nav-drawer ${isOpen ? "open" : ""}`} id="navDrawer" role="dialog" aria-label="Mobile Navigation">
        ...
        <div className="nav-drawer-actions">
          ...
          <Link to="/donate" className="btn btn-green btn-sm" onClick={closeMenu}>
            Donate Now
          </Link>
        </div>
      </div>
